...
namespace TechChallengeGame.Data.Migrations
{
    ...
    [Migration("20250919002253_AddTransactionHistoryTables")]
    partial class AddTransactionHistoryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechChallengeGame.Domain.Entities.HistoryPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TechChallengeGame.Domain.Entities.TransactionGame", b =>
                {
                    b.Property<Guid>("HistoryPaymentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("HistoryPaymentId", "GameId");

                    b.HasIndex("GameId");

                    b.HasIndex("PromotionId");

                    b.ToTable("TransactionGame", (string)null);
                });
            ...
            modelBuilder.Entity("TechChallengeGame.Domain.Entities.TransactionGame", b =>
                {
                    ...
                    b.HasOne("TechChallengeGame.Domain.Entities.HistoryPayment", "HistoryPayment")
                        .WithMany("TransactionGames")
                        .HasForeignKey("HistoryPaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
