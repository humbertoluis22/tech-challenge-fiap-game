...
namespace MicroserviceExample.Middleware;

/// <summary>
/// Middleware ultra-simples para validação básica de JWT.
/// Apenas verifica se o token é bem formado, issuer correto e não expirou.
/// Extrai informações do usuário para uso nos controllers.
/// </summary>
...
)
{
    ...
    private readonly string _expectedIssuer =
        ...
        ?? "http://ac7ef6250992e496fa5cc27193a974f5-c64b04f30effec84.elb.sa-east-1.amazonaws.com/realms/fiap-cloud-games";
